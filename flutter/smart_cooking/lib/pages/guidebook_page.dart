...
class _GuideBookState extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<GuidebookBloc>(builder: (context, GuidebookBloc bloc, _) {
      ...
      List<GuideBookModel> _gudiebookList = bloc.post;
      return Padding(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Align(
                                        alignment: Alignment.centerLeft,
                                        child: InkWell(
                                          onTap: _itemGuidebook.owning
                                              ? () =>
                                                  bloc.changeState(_itemGuidebook)
                                              : () {},
                                          child: _itemGuidebook.owning
                                              ? _itemGuidebook.status
                                                  ? Text(
                                                      "Rozłącz",
                                                      style: Theme.of(context)
