...
class Register(QWidget):
    ...
    def register(self):
        ...
        if not cur.fetchall():
            if len(login) < 3 : QMessageBox.warning(self, "Error", "Incorrect value in <b>Login</b>.")
            ...
            elif len(name) < 2 or not all(i.isalpha() or i.isspace() for i in name) or name[0].isspace(): QMessageBox.warning(self, "Error", "Incorrect value in <b>Name</b>.")
            elif len(surname) < 1 or not all(i.isalpha() or i.isspace() for i in surname): QMessageBox.warning(self, "Error", "Incorrect value in <b>Surname</b>.")
            elif len(city) < 2 or not all(i.isalpha() or i.isspace() for i in city): QMessageBox.warning(self, "Error", "Incorrect value in <b>City</b>.")
            elif not pesel.isnumeric() or len(pesel)!=11: QMessageBox.warning(self, "Error", "Incorrect value in <b>Pesel</b>.")
            elif len(post_code) !=6 or not post_code[0].isnumeric() or not post_code[1].isnumeric() or not post_code[2]=="-" or not post_code[3].isnumeric() or not post_code[4].isnumeric() or not post_code[5].isnumeric(): QMessageBox.warning(self, "Error", "Incorrect value in <b>Post Code</b>.")
            elif len(street) < 1 or not all(i.isalpha() or i.isspace() for i in street): QMessageBox.warning(self, "Error", "Incorrect value in <b>Street</b>.")
...
class Edit_data(QWidget):
    ...
    def save_try(self):
        ...
        house = self.house.text()
        email = self.email.text()
        if len(name) < 2 or not all(i.isalpha() or i.isspace() for i in name) or name[0].isspace(): QMessageBox.warning(self, "Error", "Incorrect value in <b>Name</b>.")
        elif len(surname) < 1 or not all(i.isalpha() or i.isspace() for i in surname): QMessageBox.warning(self, "Error", "Incorrect value in <b>Surname</b>.")
        elif len(city) < 2 or not all(i.isalpha() or i.isspace() for i in city): QMessageBox.warning(self, "Error", "Incorrect value in <b>City</b>.")
        elif not pesel.isnumeric() or len(pesel)!=11: QMessageBox.warning(self, "Error", "Incorrect value in <b>Pesel</b>.")
        elif not post_code[0].isnumeric() or not post_code[1].isnumeric() or not post_code[2]=="-" or not post_code[3].isnumeric() or not post_code[4].isnumeric() or not post_code[5].isnumeric() or len(post_code)!=6: QMessageBox.warning(self, "Error", "Incorrect value in <b>Post Code</b>.")
        elif len(street) < 1 or not all(i.isalpha() or i.isspace() for i in street): QMessageBox.warning(self, "Error", "Incorrect value in <b>Street</b>.")
        elif len(house)==0: QMessageBox.warning(self, "Error", "Incorrect value in <b>House</b>.")
        elif not EMAIL_REGEX.match(email): QMessageBox.warning(self, "Error", "Incorrect value in <b>E-mail</b>.")
        else:
